...
class History {
 public:
  ...
  // TASK: Read the transaction history from file.
  void read_history();

  // TASK: Insert transaction in linked list.
  void insert(Transaction *p_new_trans);

  // TASK: Sort using insertion sort.
  void sort_by_date();

  // TASK: Update the acb members in the linked list.
  void update_acb_cgl();

  // TASK: Compute the ACB, and CGL.
  double compute_cgl(unsigned int year);

  // TASK: Print the transaction history.
  void print();
